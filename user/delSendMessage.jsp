...
action.delSendMessage(request);
String pageIndex = (String)request.getAttribute("pageIndex");
String url=("/user/ViewSendMessages.do?pageIndex="+pageIndex);
...
<%=request.getAttribute("tip") %>(3秒后返回发信箱)<br/>
<a href="/user/ViewSendMessages.do?pageIndex=<%=pageIndex%>">返回发信箱</a><br/>
