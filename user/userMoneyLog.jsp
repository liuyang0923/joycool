...
UserBean toUser = UserInfoUtil.getUser(userMoneyLog.getToId());
if(toUser==null)continue;
%>
<%=userMoneyLog.getCreateDatetime().substring(5,16)%>
赠与<a href="/chat/post.jsp?toUserId=<%=toUser.getId()%>"><%= StringUtil.toWml(toUser.getNickName()) %></a>
