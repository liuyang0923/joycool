...
int size=yard.getKitchenLog().size();
...
<wml><card title="餐厅动态"><p align="left"><%=BaseAction.getTop(request, response)%>
<%=yard.getKitchenLog().getLogString(startIndex,endIndex)%>
<%=paging.shuzifenye("trends.jsp?id=" + id,true,"|",response)%>
