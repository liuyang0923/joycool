<%@ page language="java" contentType="text/vnd.wap.wml;charset=UTF-8"%><%@ page import="net.joycool.wap.bean.PagingBean"%><%@ page import="net.joycool.wap.bean.UserBean"%><%@ page import="net.joycool.wap.util.*"%><%@ page import="jc.util.SimpleChatLog2"%><%@ page import="jc.family.game.pvz.*,net.joycool.wap.framework.BaseAction"%><%!
...
<anchor>发言<go href="chat2.jsp" method="post"><postfield name="content" value="$fchat2"/></go></anchor>|<a href="chat2.jsp">刷新</a>|<a href="view.jsp">返回</a><br/>
<%=sc.getChatString(paging.getStartIndex(), NUMBER_OF_PAGE)%>
<%=paging.shuzifenye("chat2.jsp", false, "|", response)%>
<a href="view.jsp">返回游戏</a><br/>
