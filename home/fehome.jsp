...
//	HomePlayer player = homeService.getPlayer(" user_id = " + uid);
	...
	// ==========临时报名==========
//	int enterFor = homeAction.getParameterInt("ef");
//	if (enterFor == 1 && player == null){
//		player = new HomePlayer();
//		player.setUserId(uid);
//		player.setVoteCount(0);
//		player.setDel(0);
//		player.setFlag(0);
//		homeService.addNewPlayer(player);
//	}
...
HomePhotoBean photo = homeService.getHomePhoto(" id=" + homeUser.getRecommended());
if (photo != null){
%>★★推荐照片★★<br/>
