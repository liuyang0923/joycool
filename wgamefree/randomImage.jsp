<%@ page contentType="text/vnd.wap.wml;charset=utf-8"%><%@ page import="net.joycool.wap.framework.*,net.joycool.wap.action.wgamefree.WGameAction"%><%
response.setHeader("Cache-Control","no-cache");
if(session.getAttribute("randImage") == null){
	//response.sendRedirect(("index.jsp"));
	BaseAction.sendRedirect("/wgamefree/index.jsp", response);
	return;
}
