...
<anchor title="加注">加注
    <go href="round2.jsp?unique=<%=unique%>" method="post">
...
%>
<input type="text" name="wager" format="*N" maxlength="10" value="<%=sh.getRoundWager()%>" title="下注"/><br/>
<anchor title="下注">下注<go href="round2.jsp?unique=<%=unique%>" method="post"><postfield name="wager" value="$wager"/><postfield name="action" value="add"/></go></anchor>|<a href="round2.jsp?action=quit">放弃</a><br/>
<%
}
%>
