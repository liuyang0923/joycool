...
import jc.pay.alipay.util.httpClient.HttpProtocolHandler;
import jc.pay.alipay.util.httpClient.HttpRequest;
import jc.pay.alipay.util.httpClient.HttpResponse;
import jc.pay.alipay.util.httpClient.HttpResultType;
...
/*	*//**
	...
	public static String buildRequest(String strParaFileName, String strFilePath, Map<String, String> sParaTemp)
		...
		System.out.println("请求支付宝返回结果："+strResult);
		return strResult;
	}
