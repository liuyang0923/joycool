 ...
 * 
 */
public class NewsGroupInfoAction extends BaseAction {
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		// 从后台过来
			...
			if (prevNews != null) {
				String prevNewsLink = response
						.encodeURL("http://wap.joycool.net/news/NewsGroupInfo.do?newsId="
								+ prevNews.getId()
								// + "&amp;backTo="
			...
			prefixUrl = ("NewsGroupInfo.do?newsId=" + news.getId()
		...
		if (!orderBy.equals("line_index")) {
			if (prevNews != null) {
				String prevNewsLink = ("NewsGroupInfo.do?newsId="
			...
			if (nextNews != null) {
				String nextNewsLink = ("NewsGroupInfo.do?newsId="
