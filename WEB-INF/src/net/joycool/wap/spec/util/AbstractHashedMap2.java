 ...
 */
package net.joycool.wap.spec.util;
 ...
 */
public class AbstractHashedMap2 extends AbstractMap implements IterableMap {
     ...
     */
    protected AbstractHashedMap2(int initialCapacity, float loadFactor, int threshold) {
        super();
     ...
     */
    protected AbstractHashedMap2(int initialCapacity) {
     ...
     */
    protected AbstractHashedMap2(int initialCapacity, float loadFactor) {
        super();
     ...
     */
    protected AbstractHashedMap2(Map map) {
    ...
    protected static class HashMapIterator extends HashIterator implements MapIterator {
        ...
        protected HashMapIterator(AbstractHashedMap2 parent) {
            super(parent);
        }
        ...
        public Object getKey() {
            ...
            if (current == null) {
                throw new IllegalStateException(AbstractHashedMap2.GETKEY_INVALID);
            }
        ...
        public Object getValue() {
            HashEntry current = currentEntry();
            if (current == null) {
                throw new IllegalStateException(AbstractHashedMap2.GETVALUE_INVALID);
            }
        ...
        public Object setValue(Object value) {
            HashEntry current = currentEntry();
            if (current == null) {
                throw new IllegalStateException(AbstractHashedMap2.SETVALUE_INVALID);
            }
    ...
    protected static class EntrySet extends AbstractSet {
        /** The parent map */
        protected final AbstractHashedMap2 parent;
        
        protected EntrySet(AbstractHashedMap2 parent) {
            super();
            this.parent = parent;
        }
    ...
    protected static class EntrySetIterator extends HashIterator {
        ...
        protected EntrySetIterator(AbstractHashedMap2 parent) {
            super(parent);
        }
    ...
    protected static class KeySet extends AbstractSet {
        ...
        protected KeySet(AbstractHashedMap2 parent) {
            super();
            this.parent = parent;
        }
    ...
    protected static class KeySetIterator extends EntrySetIterator {
        ...
        protected KeySetIterator(AbstractHashedMap2 parent) {
            super(parent);
        }
    ...
    protected static class Values extends AbstractCollection {
        ...
        protected Values(AbstractHashedMap2 parent) {
            super();
            this.parent = parent;
        }
    ...
    protected static class ValuesIterator extends HashIterator {
        ...
        protected ValuesIterator(AbstractHashedMap2 parent) {
            super(parent);
        }
     ...
     * <p>
     * If you subclass <code>AbstractHashedMap2</code> but not <code>HashEntry</code>
     * then you will not be able to access the protected fields.
     * The <code>entryXxx()</code> methods on <code>AbstractHashedMap2</code> exist
    ...
    protected static abstract class HashIterator implements Iterator {
        ...
        protected HashIterator(AbstractHashedMap2 parent) {
            super();
            this.parent = parent;
        ...
        protected HashEntry nextEntry() { 
            ...
            if (newCurrent == null)  {
                throw new NoSuchElementException(AbstractHashedMap2.NO_NEXT_ENTRY);
            }
            HashEntry[] data = parent.data;
            int i = hashIndex;
        ...
        public void remove() {
            if (last == null) {
                throw new IllegalStateException(AbstractHashedMap2.REMOVE_INVALID);
            }
            if (parent.modCount != expectedModCount) {
                throw new ConcurrentModificationException();
            }
    ...
    protected Object clone() {
        try {
            AbstractHashedMap2 cloned = (AbstractHashedMap2) super.clone();
