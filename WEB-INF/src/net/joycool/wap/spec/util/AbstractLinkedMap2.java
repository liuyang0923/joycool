 ...
 */
public class AbstractLinkedMap2 extends AbstractHashedMap2 implements OrderedMap {
     ...
     */
    protected AbstractLinkedMap2(int initialCapacity, float loadFactor, int threshold) {
     ...
     */
    protected AbstractLinkedMap2(int initialCapacity) {
     ...
     */
    protected AbstractLinkedMap2(int initialCapacity, float loadFactor) {
     ...
     */
    protected AbstractLinkedMap2(Map map) {
        super(map);
    }
    ...
    protected static class LinkMapIterator extends LinkIterator implements OrderedMapIterator {
        ...
        protected LinkMapIterator(AbstractLinkedMap2 parent) {
            super(parent);
        }
    ...
    protected static class EntrySetIterator extends LinkIterator {
        ...
        protected EntrySetIterator(AbstractLinkedMap2 parent) {
            super(parent);
        }
    ...
    protected static class KeySetIterator extends EntrySetIterator {
        ...
        protected KeySetIterator(AbstractLinkedMap2 parent) {
            super(parent);
        }
    ...
    protected static class ValuesIterator extends LinkIterator {
        ...
        protected ValuesIterator(AbstractLinkedMap2 parent) {
            super(parent);
        }
     ...
     * <p>
     * If you subclass <code>AbstractLinkedMap2</code> but not <code>LinkEntry</code>
     * then you will not be able to access the protected fields.
     * The <code>entryXxx()</code> methods on <code>AbstractLinkedMap2</code> exist
    ...
    protected static abstract class LinkIterator
        ...
        /** The parent map */
        protected final AbstractLinkedMap2 parent;
        ...
        protected LinkIterator(AbstractLinkedMap2 parent) {
            super();
            this.parent = parent;
        ...
        protected LinkEntry previousEntry() {
            ...
            if (previous == parent.header)  {
                throw new NoSuchElementException(AbstractHashedMap2.NO_PREVIOUS_ENTRY);
            }
            next = previous;
            last = previous;
            return last;
