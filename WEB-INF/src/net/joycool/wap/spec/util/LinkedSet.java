...
import net.joycool.wap.spec.util.AbstractHashedMap2.HashEntry;
import net.joycool.wap.spec.util.AbstractLinkedMap2.LinkEntry;
...
public class LinkedSet
        extends AbstractLinkedMap2 implements Serializable, Cloneable {
    
    /**
	 * 
	 */
	private static final long serialVersionUID = -7172285844840056888L;
...
// 从开头插入entry
    public Object addFirst(Object key) {
        key = convertKey(key);
        ...
        modCount++;
        HashEntry entry2 = createEntry(data[index], hashCode, key, nullObject);
        addEntryFirst(entry2, index);
        size++;
        checkCapacity();
        
        return null;
    }
    public Object addLast(Object key) {
    	return put(key, nullObject);
    }
    
    protected void addEntryFirst(HashEntry entry, int hashIndex) {
    ...
    static class LinkedMapList extends AbstractList {
        ...
        final LinkedSet parent;
        
        LinkedMapList(LinkedSet parent) {
            this.parent = parent;
        }
