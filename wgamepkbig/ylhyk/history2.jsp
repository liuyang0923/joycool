...
List list = pkService.getWGamePKBigList("left_user_id="+loginUser.getId()+" and game_id=1 and mark=3 order by id desc limit 20");
...
UserBean user = UserInfoUtil.getUser(bean.getRightUserId());
