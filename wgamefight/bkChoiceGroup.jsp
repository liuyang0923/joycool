...
WGameFightBean fight = (WGameFightBean)request.getAttribute("fightBean");
...
<%if(fight!=null){%>
<a href="/wgamefight/pkout.jsp?groupId=<%=userBean.getGroupId()%>&amp;bkId=<%=fight.getId()%>">动作组<%=userBean.getGroupId()%></a><br/>
<%}else{%>
<a href="/wgamefight/pkout.jsp?groupId=<%=userBean.getGroupId()%>">动作组<%=userBean.getGroupId()%></a><br/>
<%}%>
<%}%>
<%}%>
