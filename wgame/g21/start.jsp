<%@ page contentType="text/vnd.wap.wml;charset=utf-8"%><%@ page import="java.util.*"%><%@ page import="net.joycool.wap.framework.BaseAction"%><%@ page import="net.joycool.wap.bean.wgame.*"%><%@ page import="net.joycool.wap.bean.*"%><%@ page import="net.joycool.wap.action.wgame.G21Action"%><%@ page import="net.joycool.wap.util.*"%><%
...
<%}else{%>
您坐庄的赌局已经被取消!交纳了场地费<%=(String)request.getAttribute("cancelMoney")%>个乐币!<br/>
<%}%>
<%
} else {
if(wins == null){
