<%@ page contentType="text/vnd.wap.wml;charset=utf-8"%><%@ page import="net.joycool.wap.framework.BaseAction"%><%@ page import="net.joycool.wap.bean.wgame.*"%><%@ page import="net.joycool.wap.action.wgame.G21Action"%><%
response.setHeader("Cache-Control","no-cache");
G21Action da = new G21Action();
da.history(request);
