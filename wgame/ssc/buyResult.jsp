<%@ page contentType="text/vnd.wap.wml;charset=utf-8"%><%@ page import="net.joycool.wap.framework.BaseAction"%><%@ page import="net.joycool.wap.spec.ssc.*" %><%
...
<%
	...
	if (left != -1 && left >= 60){
		...
		<a href="buy.jsp?type=5">波色</a>|<a href="buy.jsp?type=6">五行</a>|<a href="buy.jsp?type=7">单双</a>|<a href="buy.jsp?type=3">家禽野兽</a><br/>
<%}%>
