<%@ page contentType="text/vnd.wap.wml;charset=utf-8"%><%@ page import="net.joycool.wap.framework.BaseAction"%><%@ page import="net.joycool.wap.bean.wgame.*"%><%@ page import="net.joycool.wap.action.wgame.LgjAction"%><%
response.setHeader("Cache-Control","no-cache");
LgjAction da = new LgjAction();
da.history(request);
