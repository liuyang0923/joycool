...
<a href="round2.jsp?action=follow">跟了</a>|<a href="round2.jsp?action=quit">放弃</a><br/>
<input type="text" name="wager" format="*N" maxlength="10" value="<%=sh.getRoundWager()%>" title="下注"/><br/>
<anchor title="加注">加注
    <go href="round2.jsp" method="post">
...
%>
<input type="text" name="wager" format="*N" maxlength="10" value="<%=sh.getRoundWager()%>" title="下注"/><br/>
<anchor title="下注">下注<go href="round2.jsp" method="post"><postfield name="wager" value="$wager"/><postfield name="action" value="add"/></go></anchor>|<a href="round2.jsp?action=quit">放弃</a><br/>
<%
}
%>
提示:<br/>
本轮最多可下注<%=roundMaxWager%>个乐币<br/>
这局您还有<%=cWager%>个乐币<br/>
