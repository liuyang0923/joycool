...
<a href="round4.jsp?action=follow">跟了</a>|<a href="round4.jsp?action=quit">放弃</a>|<a href="round4.jsp?action=add&amp;wager=<%=cWager%>">梭哈</a><br/>
<input type="text" name="wager" format="*N" maxlength="10" value="<%=sh.getRoundWager()%>" title="下注"/><br/>
<anchor title="加注">加注
    <go href="round4.jsp" method="post">
...
%>
<input type="text" name="wager" format="*N" maxlength="10" value="<%=sh.getRoundWager()%>" title="下注"/><br/>
<anchor title="下注">下注<go href="round4.jsp" method="post"><postfield name="wager" value="$wager"/><postfield name="action" value="add"/></go></anchor>|<a href="round4.jsp?action=quit">放弃</a>|<a href="round4.jsp?action=add&amp;wager=<%=cWager%>">梭哈</a><br/>
<%
}
%>
提示:<br/>
