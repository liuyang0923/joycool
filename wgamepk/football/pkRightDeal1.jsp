...
<img src="/wgamepk/football/img/r-r.gif" alt="射门右vs守门右"/><br/>
    ...
    if(football.getWinUserId() == football.getLeftUserId()){
        //加入谣言
//	    WGameDataAction.addRumor("<a href=\"" + ("/wgame/hall.jsp") + "\" title=\"go\">赌场</a>:<a href=\"" + ("/chat/post.jsp?to=" + loginUser.getUserName()) + "\" title=\"go\">" + StringUtil.toWml(loginUser.getNickName()) + "</a>[<a href=\"" + ("/wgamepk/football/index.jsp") + "\" title=\"go\">射门</a>]输给" + football.getLeftNickname() + "*" + football.getWager() + "个乐币");
...
<%
        ...
        //加入谣言
//	    WGameDataAction.addRumor("<a href=\"" + ("/wgame/hall.jsp") + "\" title=\"go\">赌场</a>:<a href=\"" + ("/chat/post.jsp?to=" + loginUser.getUserName()) + "\" title=\"go\">" + StringUtil.toWml(loginUser.getNickName()) + "</a>[<a href=\"" + ("/wgamepk/football/index.jsp") + "\" title=\"go\">射门</a>]赢了" + football.getLeftNickname() + "*" + football.getWager() + "个乐币");
	    UserStatusBean usTemp=null;
	    usTemp=UserInfoUtil.getUserStatus(football.getLeftUserId());
%>
...
%>
<a href="/wgamepk/football/pkStart.jsp?userId=<%=football.getLeftUserId()%>">邀请对方再PK一局</a><br/>
<br/>
