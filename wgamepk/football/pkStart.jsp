...
%>
下注(至少10个乐币,根据射门规则将暂扣下注额两倍的乐币,您还有<%=us.getGamePoint()%>个乐币,对手<%if(enemy.getUs2()!=null){%><%=enemy.getUs2().getHatShow()%><%}%><%=StringUtil.toWml(enemy.getNickName())%>还有<%=enemyUs.getGamePoint()%>个乐币):<br/>
...
<anchor title="左">左
    <go href="/wgamepk/football/pkDeal1.jsp" method="post">
