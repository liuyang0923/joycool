...
%>
<%=tip%><br/>
<a href="/wgamepk/basketball/index.jsp">返回房间</a><br/>
<%
} else if("success".equals(result)){
%>
请选择防守方式:<br/>
<img src="/wgamepk/basketball/img/shoumen.gif" alt="球门"/><br/>
<a href="/wgamepk/basketball/chlStart.jsp?action=l&amp;bkId=<%=bkId%>">滑步防守</a><br/>
<a href="/wgamepk/basketball/chlStart.jsp?action=m&amp;bkId=<%=bkId%>">跃起封盖</a><br/>
<a href="/wgamepk/basketball/chlStart.jsp?action=r&amp;bkId=<%=bkId%>">造进攻犯规</a><br/>
<%
} 
%><br/>
