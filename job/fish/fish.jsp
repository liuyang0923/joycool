<%@ page contentType="text/vnd.wap.wml;charset=utf-8"%><%@ page import="net.joycool.wap.framework.BaseAction"%><%@ page import="net.joycool.wap.action.job.fish.*" %><%@ page import="net.joycool.wap.util.*" %><%
...
<img src="img/<%=area.getImage()%>" alt="<%=area.getName()%>"/><br/>
