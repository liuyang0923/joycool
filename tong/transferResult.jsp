...
<card title="帮主转让结果" ontimer="<%=response.encodeURL("/tong/tongManage.jsp?tongId="+tongId)%>">
<timer value="30"/>
<p align="left">
...
<%}else{%>
<card title="帮主转让结果" ontimer="<%=response.encodeURL("/tong/tong.jsp?tongId="+tongId)%>">
<timer value="50"/>
<p align="left">
<%=BaseAction.getTop(request, response)%>
<%if(tip!=null){%>
