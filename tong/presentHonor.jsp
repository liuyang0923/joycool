...
<p align="left">
<%=BaseAction.getTop(request, response)%>
确认捐赠吗？捐赠之后就拿不下来了哦~:<br/>
<anchor title="确定">确认了要捐赠
  <go href="presentHonorRs.jsp" method="post">
    <postfield name="tongId" value="<%=tong.getId()%>"/>
  </go>
</anchor><br/>
<a href="/tong/tongHonorList.jsp?tongId=<%=tong.getId()%>">算了再考虑一下</a><br/>
<%@include file="bottom.jsp"%>
</p>
</card>
<%}%>
