...
<wml>
<%if(tong!=null){%>
<card title="修改结果" ontimer="<%=response.encodeURL("/tong/revenueManage.jsp?tongId="+tong.getId())%>">
<timer value="30"/>
<p align="left">
...
<%=tip%>
<%}%><br/>
<a href="/tong/revenueManage.jsp?tongId=<%=tong.getId()%>">直接跳转 </a> <br/>
<a href="/tong/tong.jsp?tongId=<%=tong.getId()%>">返回城市 </a> <a href="/tong/tongManage.jsp">返回管理 </a><br/>
