...
topAction.socialTop(request);
Vector socialList=(Vector)request.getAttribute("socialList");
...
服务器繁忙,请稍后再试<br/>
<a href="socialTop.jsp">重试一次</a><br/>
...
userStatus=(UserStatusBean)socialList.get(i);
...
<%=nickname%>
</a><%}else{%>您自己<%}%>(<%=userStatus.getSocial()%>点)<br/>
<%}%><br/><br/>
<%}%>
