...
topAction.friendPhotoManTop(request);
Vector friendPhotoManList=(Vector)request.getAttribute("friendPhotoManList");
...
服务器繁忙,请稍后再试<br/>
<a href="photoManTop.jsp">重试一次</a><br/>
<%}else{%>
...
for(int i=0;i<friendPhotoManList.size();i++){
friendVote=(FriendVoteBean)friendPhotoManList.get(i);
