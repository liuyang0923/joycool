<%@ page contentType="text/vnd.wap.wml;charset=utf-8"%><%@ page import="net.joycool.wap.framework.BaseAction"%><%@ page import="jc.guest.question.QuestionAction"%><%@ page import="java.util.List"%><%@ page import="net.joycool.wap.bean.question.eum"%><%@ page import="net.joycool.wap.util.*"%><%@ page import="jc.guest.GuestHallAction,jc.guest.GuestUserInfo"%><%
...
<a href="historyTotal.jsp?topage=<%=action.getprepage()%>">上一页</a>
<%}%>
<%if((action.page < list.size()/10)&&(action.page < 99)){%>
<a href="historyTotal.jsp?topage=<%=action.getnexpage()%>">下一页</a><br/>
<%}%>
<br/>
