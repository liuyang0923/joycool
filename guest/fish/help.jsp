<%@ page contentType="text/vnd.wap.wml;charset=utf-8"%><%@ page import="net.joycool.wap.framework.BaseAction"%><%@ page import="jc.guest.fish.FishAction" %><%
...
<img src="/job/fish/img/logo.gif" alt="o"/><br/>
欢乐渔场游戏说明<br/>
------------------<br/>
在欢乐渔场中，你不但可以在钓到鱼后当场拿到兑换的游币。还能享受跟现实相仿的钓鱼乐趣。<br/>
1、随机事件<br/>
