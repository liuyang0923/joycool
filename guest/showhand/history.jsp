<%@ page contentType="text/vnd.wap.wml;charset=utf-8"%><%@ page import="net.joycool.wap.framework.BaseAction"%><%@ page import="net.joycool.wap.bean.wgame.*"%><%@ page import="jc.guest.wgame.ShowHandAction"%><%@ page import="jc.guest.*"%><%
response.setHeader("Cache-Control","no-cache");
ShowHandAction da = new ShowHandAction();
