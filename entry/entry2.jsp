...
if(id >= 50000 && id < 60000){
	response.sendRedirect("http://wap.g3me.cn/entry/entry2.jsp?id=" + id);
	return;
}

if(SecurityUtil.oxcxMobile(request)){
	String url = "http://wap.joycool.net/entry/entry2.jsp?id=" + id;	
    ...
    BaseAction.sendRedirect("/Column.do?columnId=27&linkId=" + id, response);
}
%>