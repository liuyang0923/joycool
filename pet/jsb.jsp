...
<p align="left">
<%=BaseAction.getTop(request, response)%>
你和<%=StringUtil.toWml(petUser.getName())%>猜拳!<br/>
请您出手势:<br/>
<a href="/pet/jsbresult.jsp?jsb=1">剪刀</a><br/>
<a href="/pet/jsbresult.jsp?jsb=2">石头</a><br/>
<a href="/pet/jsbresult.jsp?jsb=3">布</a><br/>
<br/>
<%@include file="bottom.jsp"%>
</p>
</card>
