...
<br/>
<% 
String displayIds = ",125,123,126,127,278,279,281,283,284,285,291,293,294,373,374,318,355,366,357,358,359,361,369,298,299,300,301,302,303,735,733,751,752,753,754,717,737,778,794,795,798,805,";
...
%>   
    <a href="NewsCataList.do?id=<%=catalog.getId()%>" title="返回上一级">返回<%=catalog.getName()%></a><br/>
