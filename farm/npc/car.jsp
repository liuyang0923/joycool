...
response.sendRedirect(("/farm/car.jsp"));
return;
}
...
<%=action.getTip()%><br/>
<%}else{
FarmCarBean car = (FarmCarBean)request.getAttribute("car");
%>
<%=car.getName()%><br/>
<%=car.getInfo()%><br/>
现有:<%=FarmWorld.formatMoney(farmUser.getMoney())%><br/>
需要:<%=FarmWorld.formatMoney(car.getMoney())%><br/>
