...
<%}
	...
	List itemList = SqlUtil.getIntList("select id from item where dummy_id=11 and (class1=1 or class1=2) order by id", 4);
...
<table width="100%">
	...
	<tr>
		...
		<td>
			...
			href="editEquip.jsp?id=<%=item.getId()%>"><%=item.getName()%></a>
		</td>
		<td>
	...
	<%=paging.shuzifenye("farmEquip.jsp", false, "|", response,20)%>

	<a href="index.jsp">返回新手管理首页</a><br/>
	<a href="/jcadmin/manage.jsp">返回管理首页</a>
	
	<br />
	<form method="post" action="farmEquip.jsp?add=1">
id：<input name="id"><br/>
名称：<input name="name"><br/>
描述：<input name="description"><br/>
唯一：<input name="unique" value="0"><br/>
绑定：<input name="bind" value="1"><br/>
类别：<input name="class1" value="1"><br/>
子类别：<input name="class2" value="1"><br/>
