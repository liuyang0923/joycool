...
if(request.getParameter("delete") != null){
	...
	//response.sendRedirect("tongNotice.jsp");
	BaseAction.sendRedirect("/jcadmin/tongNotice.jsp", response);
	return;
}
...
<script>
alert("添加成功！");
window.navigate("tongNotice.jsp");
</script>
<%
	    return;
	}
...
<td width="5%"><a href="tongNotice.jsp?delete=<%=notice.getId()%>">删除</a></td>
</tr>
<%
}
%>
