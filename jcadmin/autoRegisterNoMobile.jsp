<%@ page contentType="text/vnd.wap.wml;charset=utf-8"%><%@ page import="net.joycool.wap.action.user.*,net.joycool.wap.action.money.*,net.joycool.wap.framework.JoycoolSessionListener,net.joycool.wap.service.infc.*,net.joycool.wap.service.factory.*,net.joycool.wap.bean.*,net.joycool.wap.util.*"%><%@ page import="java.net.URLEncoder"%><%@ page import="net.joycool.wap.framework.BaseAction"%><%
...
乐酷快速注册为您分配的资料如下：<anchor title="确定">直接确认开始游戏
    <go href="/jcadmin/autoRegisterNoMobile.jsp?backTo=<%=backTo %>" method="post">
...
别忘了记住ID和密码哦！<br/>
若注册的登陆ID和密码遗忘或丢失，请拨打010－62059116－303或305或306让管理员帮助找回。<br/>
