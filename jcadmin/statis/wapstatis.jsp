...
int usercount=statis.getWapUserCount("2006-9-1","1=1");
int mobilecount=statis.getWapMobileCount("2006-9-1","1=1");
int count1=statis.getWapNewUserNumber("2006-9-1","login_count=1 ");
int count2=statis.getWapNewUserNumber("2006-9-1","login_count between 2 and 5 ");
int count3=statis.getWapNewUserNumber("2006-9-1","login_count between 6 and 15 ");
int count4=statis.getWapNewUserNumber("2006-9-1","login_count>15 ");
%>
<html>
<head>
</head>
