<%@ page contentType="text/html;charset=utf-8"%><%@ page import="java.util.Vector"%><%@ page import="net.joycool.wap.util.*"%><%@ page import="net.joycool.wap.service.infc.IStockService"%><%@ page import="net.joycool.wap.service.factory.ServiceFactory"%><%@ page import="net.joycool.wap.util.db.DbOperation"%><%@ page import="net.joycool.wap.bean.stock.StockNoticeBean"%><%@ page import="net.joycool.wap.framework.*"%><%@ page import="java.sql.ResultSet"%><%response.setHeader("Cache-Control", "no-cache");			
...
<%int ITEM_PER_PAGE = 5;
			...
			dbOp.init();
			ResultSet rs = dbOp
					.executeQuery("select count(*) count from jc_stock_notice  ");
			if (rs.next())
			...
			if (null != request.getParameter("delete")) {
				...
				dbOp.init();
				dbOp
						.executeUpdate("delete from jc_stock_notice where id="
								+ id);
				dbOp.release();
			}
