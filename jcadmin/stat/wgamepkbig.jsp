...
<%
	...
	if(!action.hasParam("r"))
		top = SqlUtil.getIntsList("select user_id,money/100000000 from wgame_history0_big where money>10000000000 order by money desc");
	else
		top = SqlUtil.getIntsList("select user_id,money/100000000 from wgame_history0_big where money<-10000000000 order by money");
