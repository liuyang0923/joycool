...
<%@ taglib uri="/tags/struts-logic" prefix="logic" %><%@ page import="net.joycool.wap.util.LoadResource" %><%@ page import="net.joycool.wap.service.factory.ServiceFactory" %><%@ page import="net.joycool.wap.util.SqlUtil" %><%@ page import="net.joycool.wap.util.Constants" %><%@ page import="net.joycool.wap.util.StringUtil" %><%!
public void alterQuarry(HttpServletRequest request) {
		...
		// 更新猎物信息
		String sql = "update jc_card set type_id="+typeId+",appear_rate="+appearRate+",value_type="+valueType+",action_value="+actionValue+
		",action_field="+actionField+",action_direction="+actionDirection+",description='"+description+"' where id="+id;
