...
List list = TongAction.getTongService().getTongCityRecordList(
							"tong_id=" + tong.getId() + " and mark=2 order by `count` desc limit " + start + ",20");
...
<%}%>
	...
	<br /><%=paging.shuzifenye("hshop.jsp?tongId="+tongId,true,"|",response)%><br/>
<form  action="hshop.jsp" method="post"  name="tongForm"><br/>
帮会ID：
