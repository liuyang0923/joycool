...
List list = TongAction.getTongService().getTongCityRecordList(
							"tong_id=" + tong.getId() + " and mark=3 order by `count` desc limit " + start + ",20");
...
<%}%>
	...
	<br /><%=paging.shuzifenye("shop.jsp?tongId="+tongId,true,"|",response)%><br/>
<form  action="shop.jsp" method="post"  name="tongForm"><br/>
帮会ID：
