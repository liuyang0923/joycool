...
boolean justsend = (t != null && System.currentTimeMillis() - t.longValue() < 1000*3600*24l*6);

String type = request.getParameter("type");
if(type==null){%><%if(t!=null){%>
上一次发工资的时间:<%=DateUtil.formatDate2(t.longValue())%><br/><%}%>
...
<%}%>
<a href="editTong.jsp">帮会股市绑定</a><br/>
</body>
</html>