<%@ page contentType="text/html;charset=utf-8"%><%@ page import="net.joycool.wap.framework.BaseAction"%><%@ page import="net.joycool.wap.action.home.HomeAction" %><%@ page import="net.joycool.wap.service.infc.IUserService" %><%@ page import="net.joycool.wap.service.factory.*,net.joycool.wap.service.infc.*"%><%@ page import="net.joycool.wap.bean.UserBean" %><%@ page import="net.joycool.wap.cache.util.HomeCacheUtil" %><%@ page import="net.joycool.wap.util.StringUtil" %><%@ page import="java.util.Vector" %><%@ page import="net.joycool.wap.bean.home.HomePhotoBean" %><%@ page import="net.joycool.wap.util.UserInfoUtil" %><%
...
if(inputUserId!=null)
{
	 homeUser = HomeCacheUtil.getHomePhoneListCache(StringUtil.toInt(inputUserId));
	if(homeUser==null) {
	tip="此用户照片不存在!";
	}
}
...
if(delId!=null)
{
		...
		HomeCacheUtil.deleteHomePhoneCache("id="+StringUtil.toInt(delId),StringUtil.toInt(userId));
		tip="此用户家园照片已经被删除!";
...
<td><a href="viewHomePhone.jsp?delId=<%=homeUsers.getId()%>&amp;userId=<%=user1.getId()%>">删除</a></td>
</tr>
<%}%>
<%}%>
</table>
