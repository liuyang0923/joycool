...
action.editAreaTag(request, response);
...
<script>
alert("修改成功！");
document.location = "areaTagList.jsp?zzz=1";
</script>
<%
	return;
}

AreaTagBean tag = (AreaTagBean) request.getAttribute("tag");
%>
<form action="editAreaTag.jsp" method="post">
