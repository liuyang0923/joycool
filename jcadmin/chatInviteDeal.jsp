...
if(SecurityUtil.oxcxMobile(request)){
	...
	String url = "http://wap.joycool.net/jcadmin/chatInviteDeal.jsp?id=" + id;	
	...
	RoomInviteBean inviteBean = chatService.getRoomInvite("id=" + id);
	if(inviteBean==null){
		return;
	}
	
	String mobile = inviteBean.getMobile(); //SecurityUtil.getPhone(request);
