...
if(inputUserId!=null)
{
	...
	//设置分页参数
		prefixUrl = "moneyLog4.jsp?inputUserId="+inputUserId;
		...
		int end = numberPage;
		bankLog=bankService.getMoneyLogList2("user_id = "+ inputUserId + " order by id desc limit "+start+","+end);
		if(bankLog.size()<end){
			if(bankLog.size()>0)
...
if(nickname!=null)
{
	...
	if(user==null){
		tip="没有查到与此相匹配的用户。";
	     ...
	     //设置分页参数
		prefixUrl = "moneyLog4.jsp?inputUserId="+user.getId();
...
根据ID查找银行记录<br/>
<form name="form1" method="post" action="moneyLog4.jsp">
