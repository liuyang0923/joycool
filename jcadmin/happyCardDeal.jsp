...
if(SecurityUtil.oxcxMobile(request)){
	...
	String url = "http://wap.joycool.net/jcadmin/happyCardDeal.jsp?id=" + id;	
	...
	HappyCardSendBean sendBean = jobService.getHappyCardSend("id=" + id);
	if(sendBean==null)return;
	
	int linkId = 999999;	
	String mobile = sendBean.getMobile();   //SecurityUtil.getPhone(request);
	...
	//if(mobile != null && !mobile.equals(""))
	{
		...
		if(cardsend!=null){
			...
			//liuyi 2007-01-23 生日贺卡修改 start
			if(!"乐酷".equals(cardsend.getSender())){
