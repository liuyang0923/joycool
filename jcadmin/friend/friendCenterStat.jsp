<%@ page contentType="text/html;charset=utf-8"%><%@ page import="net.joycool.wap.util.db.*"%><%@ page import="java.sql.*"%><%@ page import="net.joycool.wap.util.PageUtil"%><%@ page import="net.joycool.wap.util.StringUtil"%><%@ page import="net.joycool.wap.framework.*"%><%response.setHeader("Cache-Control", "no-cache");
...
<%int ITEM_PER_PAGE = 100;
			...
			int itemCount = 0;
			int j = 0;
			String prefixUrl = "friendCenterStat.jsp";
		...
		<table width="800" border="1">
			...
			<%try {
				...
				if (pageIndex < 0)
					pageIndex = 0;
				rs = dbOp
						.executeQuery("select id ,social_rate ,create_datetime from jc_admin_friend order by create_datetime desc limit "
								+ pageIndex
								* ITEM_PER_PAGE
								+ ","
								+ ITEM_PER_PAGE);
