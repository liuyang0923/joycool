...
<%  MentalPicAction action = new MentalPicAction(request);
	...
	if ("".equals(tip)){
		...
		pwList = (ArrayList)action.service.getQuestionList("flag=1 and del=0 order by id desc limit " + pageNow * COUNT_PRE_PAGE + "," + COUNT_PRE_PAGE);
	}
%>
<html>
	<head>
	...
	<body>
<a href="index.jsp">返回首页</a>|<a href="addPicWord.jsp">增加内容</a><br/>		
		<table border=1 width=100% align=center>
						<tr bgcolor=#C6EAF5>
							<td align=center>
								<font color=#1A4578>看图选字</font>
							</td>
							<td align=center>
						...
						<%for (int i = 0;i < pwList.size(); i++){
							...
							%><tr>
								...
								<td><a href="pwModify2.jsp?id=<%=question.getId()%>">修改内容</a>|<a href="pwModify.jsp?del=<%=question.getId()%>" onclick="return confirm('你确定要删除“<%=StringUtil.toWml(question.getTitle()) %>”?')">删除</a></td>
					 		</tr><%
						}%>
				  </table><a href="index.jsp">返回首页</a>|<a href="addPicWord.jsp">增加内容</a><br/><%=paging.shuzifenye("pwModify.jsp", false, "|", response)%>
	</body>
</html>