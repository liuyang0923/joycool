<%@ page contentType="text/vnd.wap.wml;charset=utf-8"%><%@ page import="net.joycool.wap.framework.BaseAction"%><%@ page import="net.joycool.wap.bean.question.QuestionAction"%><%@ page import="net.joycool.wap.util.*"%><%@ page import="java.util.List"%><%@ page import="net.joycool.wap.bean.question.eum"%><%
...
<a href="/question/historyToday.jsp?topage=<%=action.getprepage()%>">上一页</a>
<%}%>
<%if((action.page < list.size()/10)&&(action.page < 9)){%>
<a href="/question/historyToday.jsp?topage=<%=action.getnexpage()%>">下一页</a><br/>
<%}%>
<br/>
