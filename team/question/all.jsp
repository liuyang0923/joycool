...
<%=action.getTip()%><br/>
<%}else{
int count = SqlUtil.getIntResult("select count(*) from question_set where flag&1!=0", 3);
PagingBean paging = new PagingBean(action, count,10, "p");
List setList = action.service.getQuestionSetList("flag&1!=0 order by id desc limit " + paging.getStartIndex() + ",10");
