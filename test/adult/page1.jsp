...
%>
<%if(validate==true){%><%=JCRoomChatAction.getTransferPage("page2.jsp")%><%return;}%><%}
Vector vec=null;
...
<card title="成人用品调查问卷">
<p align="left">
在wap上有这样一个成人用品店，店里有各种成人用品（避孕用品、仿真器具、刺激性欲延时药品、保健护理药品、情趣用品等），价格比普通购买方式低廉，质量保证，同时配有详细功能介绍和应用案例（图文结合）。在这个wap小店上就能方便地进行订购，并很隐秘地邮寄或送货上门。<br/>
--------------------------<br/>
