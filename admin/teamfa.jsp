...
if(loginUser==null || !ForbidUtil.isForbid("teama",loginUser.getId())) {
...
if(interval>43200) interval = 10800;
ForbidUtil.addForbid("team",new ForbidUtil.ForbidBean(userId,loginUser.getId(),bak),interval);
LogUtil.logAdmin(loginUser.getId()+":"+userId+":添加圈子封禁"+interval+":"+bak);
%>
<%=tip%><br/>
...
<anchor title="确定">确定封禁
  <go href="teamfa.jsp" method="post">
