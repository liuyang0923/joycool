...
if(loginUser==null || !ForbidUtil.isForbid("homea",loginUser.getId())) {
...
ForbidUtil.addForbid("home",new ForbidUtil.ForbidBean(userId,loginUser.getId(),bak),interval);
LogUtil.logAdmin(loginUser.getId()+":"+userId+":添加家园封禁"+interval+":"+bak);
%>
<%=tip%><br/>
...
<anchor title="确定">确定封禁
  <go href="homefa.jsp" method="post">
