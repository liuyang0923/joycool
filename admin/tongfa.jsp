...
if(loginUser==null || !ForbidUtil.isForbid("tonga",loginUser.getId())) {
...
ForbidUtil.addForbid("tong",new ForbidUtil.ForbidBean(userId,loginUser.getId(),bak),interval);
LogUtil.logAdmin(loginUser.getId()+":"+userId+":添加帮会封禁"+interval+":"+bak);
%>
<%=tip%><br/>
...
<anchor title="确定">确定封禁
  <go href="tongfa.jsp" method="post">
