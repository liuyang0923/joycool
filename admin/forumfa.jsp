...
if(loginUser==null || !ForbidUtil.isForbid("foruma",loginUser.getId())) {
...
if(interval>4320) interval = 4320;
ForbidUtil.addForbid("forum",new ForbidUtil.ForbidBean(userId,loginUser.getId(),bak),interval);
LogUtil.logAdmin(loginUser.getId()+":"+userId+":添加论坛封禁"+interval+":"+bak);
%>
<%=tip%><br/>
...
<anchor title="确定">确定封禁
  <go href="forumfa.jsp" method="post">
