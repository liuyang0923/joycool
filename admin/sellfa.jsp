...
if(loginUser==null || !ForbidUtil.isForbid("sella",loginUser.getId())) {
...
ForbidUtil.addForbid("sell",new ForbidUtil.ForbidBean(userId,loginUser.getId(),bak),interval);
LogUtil.logAdmin(loginUser.getId()+":"+userId+":添加交易封禁"+interval+":"+bak);
%>
<%=tip%><br/>
...
<anchor title="确定">确定封禁
  <go href="sellfa.jsp" method="post">
