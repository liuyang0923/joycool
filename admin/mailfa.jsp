...
if(loginUser==null || !ForbidUtil.isForbid("maila",loginUser.getId())) {
...
ForbidUtil.addForbid("mail",new ForbidUtil.ForbidBean(userId,loginUser.getId(),bak),interval);
LogUtil.logAdmin(loginUser.getId()+":"+userId+":添加信件封禁"+interval+":"+bak);
%>
<%=tip%><br/>
...
<anchor title="确定">确定封禁
  <go href="mailfa.jsp" method="post">
