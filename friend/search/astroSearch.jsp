...
<wml>
<card title="星座搜索"><p><%=BaseAction.getTop(request, response)%><%
 %><a href="/friend/friendCenter.jsp">交友中心</a>&gt;<a href="searchCenter.jsp">搜索中心</a>&gt;星座搜索<br/>
==星座搜索==<br/>城市:<%=creditCity.getCity()%>[<anchor>修改<go href="province.jsp" method="post"><postfield name="type" value="4"/><postfield name="gender" value="$gender"/><postfield name="age" value="$age"/><postfield name="aim" value="$aim"/></go></anchor>]<br/>
...
<anchor>搜索<go href="searchResult.jsp" method="post"><postfield name="type" value="4"/><postfield name="gender" value="$gender"/><postfield name="city" value="<%=creditCity.getId()%>"/><postfield name="age" value="$age"/><postfield name="astro" value="$xz"/></go></anchor><br/>&gt;&gt;更多<a href="emotionSearch.jsp">交友</a>.<a href="homeSearch.jsp">城市</a>.<a href="superSearch.jsp">高级</a>搜索&lt;&lt;<br/>
==热门搜索==<br/><%
