...
%><%=paging.shuzifenye("more.jsp",false,"|",response)%><a href="navi.jsp">[返回可信度首页]</a><br/><%
} else {
%><%=paging.shuzifenye("more.jsp?uid=" + uid,true,"|",response)%><a href="navi2.jsp?uid=<%=uid %>">[返回可信度首页]</a><br/><%	
}%><%
} else {
