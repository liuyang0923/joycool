    	...
    	if (myInfo.getTotalPoint() < 80){			// 别忘了把设定改回80！
    		...
    		if (score >= 1 && score <= 5){
    			...
    			if (result == -1){
    				...
    				// 打分成功
    				out.clearBuffer();
					response.sendRedirect("navi2.jsp?uid=" + uid);
    				return;
    			}
    		}
    	}
...
break;
case 1:		// 低于80分
%>您好,您的可靠分数不足80%,还不能为别人打分.赶快<a href="navi.jsp">增加可信度</a>吧.<br/><%
break;
case 2:		// 打了N次分
...
%><a href="navi2.jsp?uid=<%=uid%>">[返回上一页]</a><br/><%
} else {
%><%=tip%><br/><a href="navi2.jsp?uid=<%=uid%>">返回</a><br/><%	
}%>
