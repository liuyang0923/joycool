...
<% response.setHeader("Cache-Control","no-cache");
   ...
   switch (type){
	   case 0:
		   ...
		   topLink="基本|<a href=\"navi.jsp?t=1\">工作</a>|<a href=\"navi.jsp?t=2\">生活</a>|<a href=\"navi.jsp?t=3\">外貌</a>|<a href=\"navi.jsp?t=4\">联系</a><br/>";
		   break;
	   case 1:
...
if(tmp!=0){%><a href="in.jsp?t=3">填写一下信息</a><br/><%}%>
...
case 3:%>只对好友公开<%break;
	   ...
	   break;
}%><%if(userInfo != null){%>资料更新日期:<%=DateUtil.formatDate1(new Date(userInfo.getModifyTime()))%><br/><%}%><a href="credit.jsp">[返回可信度首页]</a><br/><a href="vouch.jsp">我要去交友</a><br/>
