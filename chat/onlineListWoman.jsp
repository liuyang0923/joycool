<%@ page contentType="text/vnd.wap.wml;charset=utf-8"%><%@ page import="net.joycool.wap.framework.*"%><%@ page import="net.joycool.wap.service.factory.*,net.joycool.wap.service.infc.*,net.joycool.wap.action.chat.*"%><%@ page import="java.util.*"%><%@ page import="net.joycool.wap.util.*"%><%@ page import="net.joycool.wap.bean.*"%><%@ page import="java.net.URLEncoder"%><%
...
<a href="onlineListMan.jsp?roomId=<%=roomId%>">本室在线男</a><br/>
本室在线美女<%=onlineCount%>人<br/>
<%
