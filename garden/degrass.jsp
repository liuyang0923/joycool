...
除草成功<%=request.getAttribute("count")==null?"":",经验增加"+GardenAction.DO_EXP*((Integer)request.getAttribute("count")).intValue()+"点" %><%=request.getAttribute("level")!=null?",恭喜你升级到"+request.getAttribute("level")+"级":"" %><br/>
<%} else if(gardenAction.isResult("has")) {%>
做坏事的证据是不能被毁灭的<br/>
<%} else if(gardenAction.isResult("nograss")){%>
该地还没有杂草<br/>
<%} %>
...
<%} %>
<a href="myGarden.jsp?p=<%=gardenAction.getParameterInt("p1") %>">返回我的农场</a><br/>
